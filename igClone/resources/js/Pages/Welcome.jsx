...
export default function Welcome({ auth, laravelVersion, phpVersion }) {
    return (
        <>
            <Head title="Evan and MuMu's Shopping Site" />
            ...
            <div className="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
                ...
                <div className="m-auto bg-transparent w-6/12">
                    ...
                    <p className="text-center text-l m-auto pt-12 font-semibold text-gray-600 dark:text-gray-400 focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                        ...
                        darking shopping (and selling!) desires. Want to buy wet
                        ass fairy pussy from the dark web? Here, YOU CAN! Want
                        to sell laced drugs? Don't worry, we didn't see anything{" "}
                        <FontAwesomeIcon
                            className="animate-spin"
                            icon={faFaceGrinWink}
                        />
                        ! So go ahead and get your Walter White on! Click that
                        sign up button in the top right to get started!
                    </p>
                </div>
            </div>
